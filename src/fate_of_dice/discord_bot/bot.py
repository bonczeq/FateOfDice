...
class _Basic(Cog, name='Basic commands'):
    ...
    async def info(self, ctx: Context) -> None:
        ...
        await ctx.send(embed=discord_result)


class _Rolls(Cog, name='Roll commands'):
    __UNIVERSAL_ROLL_ALIASES: Final[list[str]] = ['r', '!', 'roll']
    __CALL_OF_CTHULHU_ALIASES: Final[list[str]] = ['c', '?', 'CoC', 'CallOfCthulhu']
    __TALES_FROM_THE_LOOP_ALIASES: Final[list[str]] = ['t', 'TftL', 'TalesFromTheLoop']
    __ALIEN_ALIASES: Final[list[str]] = ['a', 'Alien']
