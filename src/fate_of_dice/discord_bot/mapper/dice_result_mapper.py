...
def from_roll_result(skill_check: SkillCheckResult, message: Message, simple: bool = False) -> {DiceEmbed,
                                                                                                Optional[File]}:
    ...
    if not embed.simple_presentation:
        embed.add_thumbnail(skill_check.type.icon_path)
...
def from_roll_result(overcome_trouble: OvercomeTroubleResult, message: Message, simple: bool = False) -> {DiceEmbed,
                                                                                                          Optional[
                                                                                                              File]}:
...
def from_roll_result(action_check: ActionCheckResult, message: Message, simple: bool = False) -> {DiceEmbed,
                                                                                                  Optional[File]}:
